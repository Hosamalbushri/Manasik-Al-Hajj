...
namespace Webkul\Web\Database\Seeders;
...
class WebDuaDefaultsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (DB::table('web_dua_sections')->exists()) {
            return;
        }
        ...
        foreach ($sections as $sectionRow) {
            ...
            $sectionId = DB::table('web_dua_sections')->insertGetId([
            ...
            foreach ($duas as $dua) {
                DB::table('web_duas')->insert([
                    'web_dua_section_id' => $sectionId,
