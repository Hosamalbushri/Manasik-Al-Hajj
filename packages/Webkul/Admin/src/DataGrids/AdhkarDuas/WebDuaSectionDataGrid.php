...
class WebDuaSectionDataGrid extends DataGrid
{
    ...
    {
        $queryBuilder = DB::table('web_dua_sections')
            ->addSelect(
                'web_dua_sections.id',
                'web_dua_sections.slug',
                'web_dua_sections.sort_order',
                'web_dua_sections.status',
                'web_dua_sections.updated_at',
                'web_dua_sections.content',
            )
            ->orderBy('web_dua_sections.sort_order')
            ->orderBy('web_dua_sections.id');

        $this->addFilter('id', 'web_dua_sections.id');
    ...
    public function prepareColumns(): void
    {
        ...
        $this->addColumn([
            ...
            'closure'    => function ($row) {
                ...
                $title = app(WebDuaRepository::class)
