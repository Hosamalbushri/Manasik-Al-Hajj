    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'Design',
                    'info' => 'A marca do painel administrativo e da loja pública são configuradas separadamente.',

                    'admin-logo' => [
                        'favicon' => 'Favicon',
                        'logo-image' => 'Imagem do Logo',
                        'title' => 'Painel administrativo',
                        'title-info' => 'Logo e favicon usados apenas no painel admin (login, dashboard, etc.).',
                    ],
                    ...
                    'web-logo' => [
                        ...
                        'logo-image' => 'Imagem do Logo',
                        'title' => 'Web',
                        'title-info' => 'Logo, favicon e cores do tema na web pública e páginas voltadas ao visitante.',
                        'primary-color' => 'Cor principal',
                        'accent-color' => 'Cor de destaque (links)',
                        'icon-color' => 'Cor dos ícones',
                        'badge-color' => 'Cor do selo',
                        'header-middle-logo' => 'Logo central do cabeçalho',
                    ],
                ],
                'settings' => [
                    'title' => 'Settings',
