    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'Thiết kế',
                    'info' => 'Thương hiệu trang quản trị và giao diện cửa hàng được cấu hình riêng.',

                    'admin-logo' => [
                        'favicon' => 'Favicon',
                        'logo-image' => 'Hình ảnh Logo',
                        'title' => 'Trang quản trị',
                        'title-info' => 'Logo và favicon chỉ dùng trong trang quản trị (đăng nhập, bảng điều khiển, v.v.).',
                    ],
                    ...
                    'web-logo' => [
                        ...
                        'logo-image' => 'Hình ảnh Logo',
                        'title' => 'Web',
                        'title-info' => 'Logo, favicon và màu giao diện trên web công khai và trang dành cho khách.',
                        'primary-color' => 'Màu chính',
                        'accent-color' => 'Màu nhấn (liên kết)',
                        'icon-color' => 'Màu biểu tượng',
                        'badge-color' => 'Màu huy hiệu',
                        'header-middle-logo' => 'Logo giữa thanh đầu trang',
                    ],
                ],
                'settings' => [
                    'title' => 'Settings',
