    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'Diseño',
                    'info' => 'La marca del panel de administración y la tienda pública se configuran por separado.',

                    'admin-logo' => [
                        'favicon' => 'Favicon',
                        'logo-image' => 'Imagen del Logo',
                        'title' => 'Panel de administración',
                        'title-info' => 'Logo y favicon usados solo en el panel de administración (inicio de sesión, escritorio, etc.).',
                    ],
                    ...
                    'web-logo' => [
                        ...
                        'logo-image' => 'Imagen del Logo',
                        'title' => 'Web',
                        'title-info' => 'Logo, favicon y colores del tema en la web pública y páginas orientadas al visitante.',
                        'primary-color' => 'Color principal',
                        'accent-color' => 'Color de acento (enlaces)',
                        'icon-color' => 'Color de iconos',
                        'badge-color' => 'Color de insignia',
                        'header-middle-logo' => 'Logo central del encabezado',
                    ],
                ],
                'settings' => [
                    'title' => 'Configuraciones',
