    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'Tasarım',
                    'info' => 'Yönetici paneli ve mağaza vitrin markaları ayrı yapılandırılır.',

                    'admin-logo' => [
                        'favicon' => 'Favicon',
                        'logo-image' => 'Logo Resmi',
                        'title' => 'Yönetici Paneli',
                        'title-info' => 'Yalnızca yönetici panelinde (giriş, kontrol paneli vb.) kullanılan logo ve favicon.',
                    ],
                    ...
                    'web-logo' => [
                        ...
                        'logo-image' => 'Logo Resmi',
                        'title' => 'Web',
                        'title-info' => 'Herkese açık web ve ziyaretçi sayfalarında logo, favicon ve tema renkleri.',
                        'primary-color' => 'Ana renk',
                        'accent-color' => 'Vurgu rengi (bağlantılar)',
                        'icon-color' => 'Simge rengi',
                        'badge-color' => 'Rozet rengi',
                        'header-middle-logo' => 'Üst bilgi orta logosu',
                    ],
                ],
                'settings' => [
                    'title' => 'Ayarlar',
