    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'طراحی',
                    'info' => 'برندینگ پنل مدیریت و فروشگاه به‌صورت جداگانه تنظیم می‌شود.',

                    'admin-logo' => [
                        'favicon' => 'Favicon',
                        'logo-image' => 'تصویر لوگو',
                        'title' => 'پنل مدیریت',
                        'title-info' => 'لوگو و favicon فقط در پنل مدیریت (ورود، داشبورد و غیره) استفاده می‌شود.',
                    ],
                    ...
                    'web-logo' => [
                        ...
                        'logo-image' => 'تصویر لوگو',
                        'title' => 'وب',
                        'title-info' => 'لوگو، favicon و رنگ‌های پوسته در وب عمومی و صفحات بازدیدکننده.',
                        'primary-color' => 'رنگ اصلی',
                        'accent-color' => 'رنگ تأکید (پیوندها)',
                        'icon-color' => 'رنگ آیکن',
                        'badge-color' => 'رنگ نشان',
                        'header-middle-logo' => 'لوگوی میانی هدر',
                    ],
                ],
                'settings' => [
                    'title' => 'تنظیمات',
