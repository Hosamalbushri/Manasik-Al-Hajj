...
use Webkul\Admin\Http\Controllers\AdminLocaleController;
...
/**
 * Admin UI language (session; separate from storefront locale).
 */
Route::get('switch-admin-locale/{locale_code}', [AdminLocaleController::class, 'switch'])
