...
return [
    'seeders' => [
        ...
        'web-theme' => [
            ...
            'supplications' => [
                'heading' => 'الأدعية والأذكار',
                'subheading' => 'أدعية وأذكار موثوقة مختارة للحاج والمعتمر—نفس المحتوى المعروض في صفحة الأذكار والأدعية. استخدم «عرض المزيد» للاطلاع على المكتبة كاملة.',
            ],
            'manasik-showcase' => [
                'heading' => 'مناسك الحج في لمحة',
                'subheading' => 'أبرز المراحل من الإحرام إلى طواف الوداع—افتح دليل المناسك كاملاً للتفاصيل والأدعية والتذكيرات.',
            ],
            'section-divider' => [
                'prayer' => [
                    'title'       => 'مواقيت الصلاة',
                    'description' => 'أوقات الصلوات اليومية لمدينتك مع التاريخ الهجري والميلادي.',
                ],
                'supplications' => [
                    'title'       => 'الأذكار والأدعية',
                    'description' => 'أدعية مختارة للسفر والمناسك. البطاقات أدناه كما في صفحة الأذكار—استخدم «عرض المزيد» للمكتبة كاملة.',
                ],
                'maps' => [
                    'title'       => 'المواقع المقدسة والخرائط',
                    'description' => 'دليل بأهم المواقع المرتبطة بمناسك الحج والعمرة: استعرض البطاقات أدناه، ثم انتقل إلى صفحة الخرائط لجميع المواقع والعرض التفاعلي.',
                ],
            ],
            'maps-showcase' => [
                'link_all' => 'عرض كل الخرائط',
                'heading' => 'المواقع المقدسة والخرائط',
                'subheading' => 'أهم المواقع المرتبطة بمناسك الحج والعمرة: استعرض البطاقات أدناه، ثم انتقل إلى صفحة الخرائط للدليل الكامل والعرض التفاعلي.',
            ],
            'static-hajj-tips' => [
                'heading' => 'نصائح ذهبية للحجاج',
                'subheading' => 'مجموعة من النصائح والإرشادات المهمة لكل حاج ومعتمر.',
